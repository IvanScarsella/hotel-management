...
const RoomDetails = (props: { params: { slug: string } }) => {
  ...
  const handleBookNowClick = async () => {
    if (!checkinDate || !checkoutDate)
      return toast.error('Please provide checkin / ckeckout date')

    if (checkinDate > checkoutDate)
      return toast.error('Please choose a valid checkim period')
            ...
            <div>
              ...
              <div className="flex my-11">
                {room.offeredAmenities.map((amenity) => (
                  <div
                    key={amenity._key}
                    className="md:w-44 w-fit text-center px-2 md:px-0 h-20 ms:h-40 mr-3 bg-[#eff0f2] dark:bg-gray-800 rounded-lg grid place-content-center"
                  >
