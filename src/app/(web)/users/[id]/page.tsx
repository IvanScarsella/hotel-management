...
const UserDetails = (props: { params: { id: string } }) => {
   ...
   return (
      <div className="container mx-auto px-2 ms:px-4 py-10">
               ...
               <nav className="sticky top-0 px-2 w-fit mx-auto md:w-full md:px-5 py-3 mb-8 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 mt-7">
                  ...
                  >
                     ...
                     >
                        ...
                        <a className="inline-flex items-center mx-1 ms:mx-3 text-xs md:text-sm font-medium">
                           Current Bookings
                        </a>
                     </li>
                  </ol>
                  <ol
                     className={`${currentNav === 'amount' ? 'text-blue-600' : 'text-gray-700'} inline-flex mr-1 md:mr-5 items-center space-x-1 ms:space-x-3`}
                  >
                     <li
